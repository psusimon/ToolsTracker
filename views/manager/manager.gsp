...
<title>ToolsTracker: Tool Manager</title>
		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li class="active"><g:link controller="manager" action="index">Tool Manager</g:link></li>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="panel-body form-horizontal payment-form">
					<g:form name="add" action="addTool">
						...
						<div class="form-group">
							<label for="concept" class="col-sm-3 control-label">Maintenance
								Schedule</label>
							<div class="col-sm-9">
								<select class="form-control" id="maintenanceSchedule" name="maintenanceSchedule">
